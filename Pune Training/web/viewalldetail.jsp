			...
			<div id="container" class="clearfix">
				<div id="mainCol" class="clearfix">
					...
					<ul id="maincon">
						...
						<%ResultSet rs1 = stmt.executeQuery("select * from binfo where id='"+id+"' ");
							while (rs1.next()) {
						...
						<li class="clearfix">
							...
							<p>
								<b>Course:</b>&nbsp;&nbsp;&nbsp;&nbsp;<%=rs1.getString("cname")%></br>
								 <b>Starting Batch date :</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rs1.getString("sbdate")%></br>
								 <b>Fee:</b>&nbsp;&nbsp;<%=rs1.getString("fee")
							%><br>
							<b>Duration:</b>&nbsp;&nbsp;<%=rs1.getString("duration")
							%><br>
						...
						<form action="checkLogin.jsp">
							...
							<p class="clearfix">
								<label for="password">Password</label> <input name="pwd"
									id="password" type="text" value="" required />
							</p>
